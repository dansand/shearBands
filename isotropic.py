...
# 
# 
# figVelocityPressure.append( glucifer.objects.Points(swarmCustom , pointSize=6.0,colourBar=False) )
# figVelocityPressure.append( glucifer.objects.Points(shearbandswarm, pointSize=2.0, colourBar=False) )
# 
# 
